...
const Category = () => {
  return (
    <div className="w-11/12 mx-auto md:grid grid-cols-2 lg:grid-cols-4 gap-20 md:py-10">
      <div className="h-[300px] bg-[#fff4d9] rounded-xl shadow-md relative hover:scale-105 transition-all duration-300 cursor-pointer mb-6">
      ...
      <div className="h-[300px] bg-[#e8f5da] rounded-xl shadow-md relative hover:scale-105 transition-all duration-300 cursor-pointer mb-6">
      ...
      <div className="h-[300px] bg-[#e4eef7] rounded-xl shadow-md relative hover:scale-105 transition-all duration-300 cursor-pointer mb-6">
      ...
      <div className="h-[300px] bg-[#f0e2e1] rounded-xl shadow-md relative hover:scale-105 transition-all duration-300 cursor-pointer mb-6">
